...
#define CIF_ISP_CTRL_ISP_MODE_RAW_PICT         0
...
#define CIF_ISP_CTRL_ISP_GAMMA_IN_DIS          0
#define CIF_ISP_CTRL_ISP_AWB_ENA               BIT(7)
#define CIF_ISP_CTRL_ISP_AWB_DIS               0
...
#define CIF_VI_DPCL_DMA_SW_SPMUX           0
...
#define CIF_MI_CTRL_INIT_BASE_DIS          0
#define CIF_MI_CTRL_INIT_OFFSET_EN         BIT(21)
#define CIF_MI_CTRL_INIT_OFFSET_DIS        0
#define CIF_MI_CTRL_MP_WRITE_FMT(a)        ((a) << 22)
#define CIF_MI_CTRL_MP_WRITE_FMT_PLA       0
...
#define CIF_MI_CTRL_SP_OUTPUT_FMT_YUV400   0
...
#define CIF_MI_DMA_CTRL_READ_FMT_PLANAR    0
...
#define CIF_MI_DMA_CTRL_FMT_YUV400         0
#define CIF_MI_DMA_CTRL_BYTE_SWAP          BIT(8)
#define CIF_MI_DMA_CTRL_NO_BYTE_SWAP       0
#define CIF_MI_DMA_CTRL_CONTINUOUS_ENA      BIT(9)
#define CIF_MI_DMA_CTRL_CONTINUOUS_DIS     0
#define CIF_MI_DMA_CTRL_RGB_BAYER_NO       0
...
#define CIF_ICCL_ALL_CLK                   0xFFFFFFFF
...
#define CIF_C_PROC_CTR_DIS                 0
#define CIF_C_PROC_YOUT_FULL               BIT(1)
#define CIF_C_PROC_YOUT_LIM                0
#define CIF_C_PROC_YIN_FULL                BIT(2)
#define CIF_C_PROC_YIN_LIM                 0
#define CIF_C_PROC_COUT_FULL               BIT(3)
#define CIF_C_PROC_COUT_LIM                0

/* DUAL_CROP_CTRL */
#define CIF_DUAL_CROP_MP_MODE_BYPASS      0
#define CIF_DUAL_CROP_MP_MODE_YUV         BIT(0)
#define CIF_DUAL_CROP_MP_MODE_RAW         (2 << 0)
#define CIF_DUAL_CROP_SP_MODE_BYPASS      0
...
#define CIF_IMG_EFF_CTRL_MODE_BLACKWHITE  0
...
#define CIF_JPE_TAB_ID_QUANT0              0
/* JPE_ENCODER_BUSY */
#define CIF_ENCODER_BUSY                   BIT(0)
/* JPE_HEADER_MODE */
#define CIF_JPE_HEADER_MODE_NOAPPN         0
...
#define CIF_MIPI_CTRL_ERR_SOT_HS_ENA         0
#define CIF_MIPI_CTRL_ERR_SOT_HS_SKIP        BIT(16)
#define CIF_MIPI_CTRL_ERR_SOT_SYNC_HS_ENA    0
...
#define CIF_SUPER_IMP_CTRL_BYPASS_MODE 0
#define CIF_SUPER_IMP_CTRL_REF_IMG_MEM BIT(1)
#define CIF_SUPER_IMP_CTRL_REF_IMG_IE  0
#define CIF_SUPER_IMP_CTRL_TRANSP_DIS  BIT(2)
#define CIF_SUPER_IMP_CTRL_TRANSP_ENA  0

/* ISP HISTOGRAM CALCULATION : ISP_HIST_PROP */
#define CIF_ISP_HIST_PROP_PDIV(a)    ((a) << 3)
#define CIF_ISP_HIST_PROP_MODE_DIS   0
...
#define ISP_AFM_CTRL_DISABLE  0

/* SHUTTER CONTROL */
#define CIF_ISP_SH_CTRL_SH_ENA      BIT(0)
#define CIF_ISP_SH_CTRL_SH_DIS      0
#define CIF_ISP_SH_CTRL_REP_EN      BIT(1)
#define CIF_ISP_SH_CTRL_REP_DIS     0
#define CIF_ISP_SH_CTRL_SRC_SH_TRIG BIT(2)
#define CIF_ISP_SH_CTRL_SRC_VSYNC  0
#define CIF_ISP_SH_CTRL_EDGE_POS    BIT(3)
#define CIF_ISP_SH_CTRL_EDGE_NEG   0
#define CIF_ISP_SH_CTRL_POL_LOW     BIT(4)
#define CIF_ISP_SH_CTRL_POL_HIGH   0

/* FLASH MODULE */
/* ISP_FLASH_CMD */
#define CIF_FLASH_CMD_PRELIGHT_ON   BIT(0)
#define CIF_FLASH_CMD_PRELIGHT_OFF  0
#define CIF_FLASH_CMD_FLASH_ON      BIT(1)
#define CIF_FLASH_CMD_FLASH_OFF     0
#define CIF_FLASH_CMD_PRE_FLASH_ON  BIT(2)
#define CIF_FLASH_CMD_PRE_FLASH_OFF 0
/* ISP_FLASH_CONFIG */
#define CIF_FLASH_CONFIG_PRELIGHT_BEG   0
#define CIF_FLASH_CONFIG_PRELIGHT_END   BIT(0)
#define CIF_FLASH_CONFIG_VSYNC_NEG      0
#define CIF_FLASH_CONFIG_VSYNC_POS      BIT(1)
#define CIF_FLASH_CONFIG_PRELIGHT_HIGH  0
#define CIF_FLASH_CONFIG_PRELIGHT_LOW   BIT(2)
#define CIF_FLASH_CONFIG_SRC_VSYNC      0
